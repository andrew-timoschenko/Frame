...
// Определение усилий и моментов в раме по схеме 126 [Бычков Д.В. Формулы и графики для расчета рам. -М.: Госстройиздат, 1957]
...
// единичное смещение стойки ас по вертикали
